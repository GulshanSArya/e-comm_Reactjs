          ...
          <div class="row g-3">
            <div class="col-md-5 col-lg-4 order-md-last">
              ...
              <div class="card-body">
                ...
                <p class="card-text">+91{order.shipping_address.phone}</p>
              </div>
            </div>:null}
            ...
            {user.addresses.map((address)=>
              ...
              <div class="card-body">
                ...
                <p class="card-text">+91{address.phone}</p>
              ...
              <form class="needs-validation" novalidate="" onSubmit={(e)=>{e.preventDefault();validateAddress(address)}}>
                <div class="row g-3">
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" id="firstName" placeholder="" required="" value={address.first_name} onChange={e=>setAddress({...address, first_name:e.target.value})}/>
